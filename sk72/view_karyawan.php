...
<table width="614" height="134" border="1" align="center">
  <tr>
	...
	<td width="99" bgcolor="#999999"><div align="center"><strong>NIM</strong></div></td>
    ...
    <td width="32" bgcolor="#999999"><div align="center"><strong>SP </strong></div></td>
  ...
  ?>
    ...
    <td><div align="center"><?php echo $row['SP']; ?></div>      </td>
